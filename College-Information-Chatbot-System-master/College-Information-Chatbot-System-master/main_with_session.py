...
# -*- coding: utf-8 -*-
"""
@author:PRADEEP,KARTHIK,LIKITH,VARSHINI.
"""
...
GREETING = ['Hello! My name is chat-bot. I will try my best to provide you information related to our College!']
...
AUTH_KEYWORDS = ['login', 'cgpa', 'sgpa', 'grades', 'percentage']
...
#    print(result)
    c.close()
    conn.close()
    return("Your semester wise Marks is as follows: " +str(res_list))
        ...
        if(len(inp.split(" "))==1):
            if(isKeyword(inp)==False):
                ...
                if(PWD_REQ==1):
                    ...
                    PWD_REQ = 0
                    return "I'll now be able to answer your related queries if your credentials are valid! Otherwise you will have to provide your credentials again!"
